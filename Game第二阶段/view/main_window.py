...
from view.pages.login_register_page import LoginRegisterPage
...
class MainWindow(tk.Tk, Observer):
    ...
    def _init_pages(self):
        ...
        # 登录注册页
        login_register = LoginRegisterPage(self.container, self.app_controller)
        self.pages["login_register"] = login_register
        login_register.grid(row=0, column=0, sticky="nsew")
