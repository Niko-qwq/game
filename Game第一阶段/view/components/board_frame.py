...
class BoardFrame(ttk.Frame):
    ...
    def setup_widgets(self):
        ...
        # 创建画布用于绘制棋盘和棋子，初始大小较小
        self.canvas = tk.Canvas(self.center_frame, bg="#D2B48C", highlightthickness=0, width=400, height=400)
        # 使用place方法居中显示画布
    ...
    def draw_board(self):
        ...
        # 设置每个格子的大小（固定大小，确保棋盘清晰）
        grid_size = 30
        # 计算画布大小，确保刚好适合棋盘（边缘留出一个格子的空间）
